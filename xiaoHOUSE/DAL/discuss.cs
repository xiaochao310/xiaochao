...
namespace xiaoHOUSE.DAL
{
	...
	public partial class discuss
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "discuss"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(xiaoHOUSE.Model.discuss model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into discuss(");
			strSql.Append("artID,userID,userName,disDate,Contents,rootID)");
			...
			parameters[3].Value = model.disDate;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(xiaoHOUSE.Model.discuss model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public xiaoHOUSE.Model.discuss GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,artID,userID,userName,disDate,Contents,rootID from discuss ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public xiaoHOUSE.Model.discuss DataRowToModel(DataRow row)
		{
			xiaoHOUSE.Model.discuss model=new xiaoHOUSE.Model.discuss();
			if (row != null)
			{
				...
				if(row["disDate"]!=null && row["disDate"].ToString()!="")
				{
					model.disDate=DateTime.Parse(row["disDate"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,artID,userID,userName,disDate,Contents,rootID ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,artID,userID,userName,disDate,Contents,rootID ");
			strSql.Append(" FROM discuss ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
